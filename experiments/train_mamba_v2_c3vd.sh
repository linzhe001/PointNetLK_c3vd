...
#$ -l gpu_type=a6000
#$ -pe gpu 1
#$ -N ljiang_train_mamba_v2_c3vd
#$ -o /SAN/medic/MRpcr/logs/mamba_v2_c3vd_output.log
#$ -e /SAN/medic/MRpcr/logs/mamba_v2_c3vd_error.log
#$ -wd /SAN/medic/MRpcr

#=============================================================================
# Mamba3D-v2 C3VD 分类器训练脚本 (无领域适应)
#=============================================================================
#
# 此脚本训练一个不使用领域判别器的Mamba3D-v2分类器。
# 使用 mamba-ssm 库的高性能CUDA算子，显著提升计算效率。
# 已删除对抗损失模块，仅使用标准分类损失。
#
#=============================================================================
...
# --- 打印配置信息 ---
echo "========== Mamba3D-v2 C3VD分类器训练配置 =========="
echo "模型: Mamba3D-v2 (高性能版本) (无领域适应)"
...
# Stage 1: 训练分类器 (无领域对抗)
# =============================================
echo "========== Stage 1: 训练Mamba3D-v2分类器 =========="
CLASSIFIER_PREFIX="/SAN/medic/MRpcr/results/mamba_v2_c3vd/mamba_v2_classifier_${DATE_TAG}"
