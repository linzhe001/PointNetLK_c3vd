...
#$ -l gpu_type=a6000
#$ -pe gpu 1
#$ -N ljiang_train_cformer_c3vd_full
#$ -o /SAN/medic/MRpcr/logs/f_cformer_c3vd_output.log
#$ -e /SAN/medic/MRpcr/logs/f_cformer_c3vd_error.log
#$ -wd /SAN/medic/MRpcr
...
# 定义输出路径
CLASSIFIER_PREFIX="/SAN/medic/MRpcr/results/cformer_c3vd/cformer_classifier_${DATE_TAG}"
POINTLK_PREFIX="/SAN/medic/MRpcr/results/cformer_c3vd/cformer_pointlk_${DATE_TAG}"
...
# 保存详细配置信息
CONFIG_FILE="/SAN/medic/MRpcr/results/cformer_c3vd/cformer_c3vd_${DATE_TAG}_config.txt"
echo "🧠 CFormer 两阶段训练配置信息" > ${CONFIG_FILE}
echo "=====================================" >> ${CONFIG_FILE}
