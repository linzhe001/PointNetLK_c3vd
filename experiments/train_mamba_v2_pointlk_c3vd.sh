...
#$ -l gpu_type=a6000
#$ -pe gpu 1
#$ -N ljiang_train_mamba_v2_pointlk
#$ -o /SAN/medic/MRpcr/logs/mamba_v2_pointlk_c3vd_output.log
#$ -e /SAN/medic/MRpcr/logs/mamba_v2_pointlk_c3vd_error.log
#$ -wd /SAN/medic/MRpcr
...
POINTLK_PREFIX="/SAN/medic/MRpcr/results/mamba_v2_c3vd/mamba_v2_pointlk_${DATE_TAG}"
