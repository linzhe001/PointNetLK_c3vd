...
#$ -l gpu_type=a6000
#$ -pe gpu 1
#$ -N ljiang_train_mamba_v3_se_pointlk
#$ -o /SAN/medic/MRpcr/logs/mamba_v3_se_pointlk_c3vd_output.log
#$ -e /SAN/medic/MRpcr/logs/mamba_v3_se_pointlk_c3vd_error.log
#$ -wd /SAN/medic/MRpcr
...
echo "损失结构: loss_r + loss_g + 0.1*全局特征一致性损失"
echo "==============================================="
...
POINTLK_PREFIX="/SAN/medic/MRpcr/results/mamba_v3_se_c3vd/mamba_v3_se_pointlk_${DATE_TAG}"
