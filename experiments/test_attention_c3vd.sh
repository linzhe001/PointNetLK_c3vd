...
echo "========== AttentionNet Registration Model Test Configuration =========="
...
echo ""
echo "========== Starting AttentionNet Registration Model Test =========="
...
if [ $? -eq 0 ]; then
    echo ""
    echo "🎉 AttentionNet registration model test completed!"
...
echo "🧠 AttentionNet Registration Model Test Configuration" > ${CONFIG_FILE}
echo "=====================================" >> ${CONFIG_FILE}
...
echo ""
echo "🎉🎉🎉 AttentionNet registration model test all completed! 🎉🎉🎉" 